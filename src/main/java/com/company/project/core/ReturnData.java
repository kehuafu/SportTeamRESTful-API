...
public class ReturnData<T> implements Serializable {
    ...
    public ReturnData msg(WxResultCode resultCode) {
    ...
    public ReturnData(T data) {
        this.code = WxResultCode.SUCCESS.getCode();
        this.msg = WxResultCode.SUCCESS.getMessage();
        this.data = data;
    }

    public ReturnData(T data , WxResultCode resultCode) {
